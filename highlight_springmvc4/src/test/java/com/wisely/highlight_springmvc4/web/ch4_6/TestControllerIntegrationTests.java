...
// @WebAppConfiguration 注解在类上，用来声明加载的 ApplicationContext 是一个
// WebApplicationContext。它的属性指定的是 Web 资源的位置，默认为 src/main/webapp，本例修改为 src/main/resources。
...
public class TestControllerIntegrationTests {
    ...
    public void testNormalController() throws Exception {
        ...
        .andExpect(view().name("page")) // 预期 view 的名称为page。
        .andExpect(forwardedUrl("/WEB-INF/classes/views/page.jsp")) // 预期页面专项的真正路径为/WEB-INF/classes/views/page.jsp
        .andExpect(model().attribute("msg", demoService.saySomething())); // 预期 model 里的值是 demoService.saySomething()返回值 hello。
    }
    ...
    public void testRestController() throws Exception {
        ...
        .andExpect(content().string(demoService.saySomething())); // 预期返回值的内容为 demoService.saySomething()返回值 hello。
    }
